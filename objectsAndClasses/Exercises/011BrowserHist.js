function browser(object, arr) {

    // let newObj = {
    //     'Browser Name': object['Browser Name'],
    //     'Open Tabs': [...object['Open Tabs']],
    //     'Recentyle Closed': [...object['Recently Closed']],
...
browser({"Browser Name":"Google Chrome","Open Tabs":["Facebook","YouTube","Google Translate"], "Recently Closed":["Yahoo","Gmail"], "Browser Logs":["Open YouTube","Open Yahoo","Open Google Translate","Close Yahoo","Open Gmail","Close Gmail","Open Facebook"]},
